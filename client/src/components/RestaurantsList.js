    ...
    return(
        <div>
            <div className="row pb-1">
                ...
                <div className="input-group col-lg-4">
                    <input type="text" clas="form-control" placeholder="Search by zip" value={searchZip} onChange={(e) => setSearchZip(e.target.value)} />
                    <div className="input-group-append">
                        <button className="btn btn-outline-secondary" type="button" onClick={findByZip}>Search</button>
                    </div>
                </div>
                <div className="input-group col-lg-4">
                    <select onChange={(e) => setSearchCuisine(e.target.value)}>
